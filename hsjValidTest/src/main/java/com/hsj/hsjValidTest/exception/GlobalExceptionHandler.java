...
public class GlobalExceptionHandler {
    ...
    public JSONResultWrapper validationErrorHandler(MethodArgumentNotValidException ex) {
        ...
        return JSONResultWrapper.errorWithMessageAndObject(ResultStatus.param_error.code(), ResultStatus.param_error.getReasonPhrase(), errorInformation
        );
    }
    ...
    public JSONResultWrapper validationErrorHandlerDefault(Exception e) {
        return JSONResultWrapper.errorWithMessageAndObject(ResultStatus.param_error.code(), ResultStatus.param_error.getReasonPhrase(), e.getMessage()
        );
    }
}
